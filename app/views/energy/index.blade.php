...
<section class="panel panel-success" xmlns="http://www.w3.org/1999/html">
    <header class="panel-heading ">
        ...
        <a class="btn btn-success btn-xs pull-right " href='{{ url("clientAdd") }}'>
    ...
    <div class="panel-body">
        ...
        <table  class="display table table-bordered table-striped" id="dynamic-table">
            ...
            <tbody>
            @foreach($energy as $energy)
            <tr>

                <td>{{++$j}}</td>
                <td>{{$energy->voltage}}</td>
                <td>{{$energy->current_one}}</td>
                <td>{{$energy->current_two}}</td>

                <td class="table-condensed col-xs-pull-2" id="{{ $energy->id }}">
                    <div class="btn-group btn-group-xs" >

                        <a class="btn btn-primary" title="edit hospital" href='{{ url("energy/edit/{$energy->id}") }}'>
